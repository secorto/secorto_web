...
- Para enlazar traducciones utiliza `translationKey`, que es el identificador canónico del mensaje
  (nombre estable y semántico, independiente del nombre de fichero).
