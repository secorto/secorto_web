...
1. Actualizar `src/domain/section.ts` si cambia la configuración de una sección
...
5. Actualizar `ARCHITECTURE_DIAGRAM.mermaid` y `ARCHITECTURE_DIAGRAM.svg` si el flujo cambia de forma significativa
